...
class TakeQuizActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnOption1.setOnClickListener { selectAnswer(btnOption1) }
        btnOption2.setOnClickListener { selectAnswer(btnOption2) }
        btnOption3.setOnClickListener { selectAnswer(btnOption3) }
        btnOption4.setOnClickListener { selectAnswer(btnOption4) }
